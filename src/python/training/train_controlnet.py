...
def main(args):
    ...
    if args.use_pretrained == 1:
        ...
        scheduler = PNDMScheduler.from_pretrained(args.source_model, subfolder="scheduler")
        ...
        if ".pt" in args.ddpm_uri:
            ...
            for diffusion_model in diffusion_models:
                ...
                try:
                    ...
                    print(ckpt["diffusion"])
                    model_state_dict = ckpt["diffusion"]
    ...
    # Scale Factor: the vae scaling factor will be used to (a) multiply vae-encoded latents and (b) divide latents before vae-decoding
